...
class HomeFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exitTransition = inflater.inflateTransition(R.transition.home_scren_transition)
    ...
    override fun onCreateView(
        ...
        categoriesAdaptor.onClickListener(object : OnClick {
            override fun onclicklistner(category: Category) {
                ...
                /* var intent = Intent(requireContext(),CategoryActivity::class.java)
                 ...
                 Toast.makeText(requireActivity(), "${category.Tital}", Toast.LENGTH_SHORT).show()*/
            }
        ...
        shopListAdaptor.onClickEvent(object : OnClickItem {
            override fun OnClickItemList(shopList: ShopList, pos: Int) {
                ...
                startActivity(intent)
                Toast.makeText(requireActivity(), "${shopList.shopName}", Toast.LENGTH_SHORT).show()
            }
