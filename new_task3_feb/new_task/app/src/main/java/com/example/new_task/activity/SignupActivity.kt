...
class SignupActivity : AppCompatActivity() {
   ...
   private var base64: String? = null
    ...
    private fun insertData(
        ...
        //Post Api Calling
        ApiClint.init(this).fromField(user(name = Name, email = Email, password = Password, mobile_no = phoneNo, upload = "", dob = dob)).enqueue(object :
            ...
            override fun onResponse(call: Call<ResponseData>, response: retrofit2.Response<ResponseData>){
                ...
                Log.e("onCreateView", "onResponse: $Udata", )
