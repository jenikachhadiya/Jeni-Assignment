...
class ImgList(var context: Context) {
    ...
    fun adsList(bannerList:ArrayList<Category>){
        bannerList.add(Category(1,"https://img.freepik.com/premium-vector/advertising-banners-placing-digital-ads-with-ease-banners-promotional-media_101434-769.jpg?w=1380",null))
        bannerList.add(Category(2,"https://img.freepik.com/free-vector/woman-knocking-locked-closed-door_74855-5827.jpg?w=1380&t=st=1674541440~exp=1674542040~hmac=b59dba914d3f76e81bc00fa1d8d6fb6a831aa2d6bc298ac3cb6bbf48bd35acd9",null))
        bannerList.add(Category(3,"https://img.freepik.com/free-psd/digital-business-marketing-web-banner-template_237398-62.jpg?w=1380&t=st=1674541484~exp=1674542084~hmac=6702c21f41f4fe22b411e7f07de39390941b64b68c02e1be8acfdb027977f79f",null))
        bannerList.add(Category(4,"https://img.freepik.com/free-psd/digital-business-marketing-web-banner-template_237398-62.jpg?w=1380&t=st=1674541484~exp=1674542084~hmac=6702c21f41f4fe22b411e7f07de39390941b64b68c02e1be8acfdb027977f79f",null))
        bannerList.add(Category(5,"",null))
        bannerList.add(Category(6,"",null))
    }
