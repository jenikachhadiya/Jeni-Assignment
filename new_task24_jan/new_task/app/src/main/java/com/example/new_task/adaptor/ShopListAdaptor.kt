...
class ShopListAdaptor(var context: Context, var shopList: MutableList<ShopList?>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder1) {
            ...
            Glide
                .with(context)
                .load("https://img.freepik.com/premium-vector/advertising-banners-placing-digital-ads-with-ease-banners-promotional-media_101434-769.jpg?w=1380")
                .centerCrop()
